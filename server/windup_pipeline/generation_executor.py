...
class GenerationExecutor:
    def __init__(self, *, root: Path, data_root: Path, jobs_root: Path, jobs, catalog):
        self.root = root
        self.data_root = data_root
        self.jobs_root = jobs_root
        self.jobs = jobs
        self.catalog = catalog
        self.actions = ActionPipeline(official_frame=catalog.official_frame)
    ...
    def run_action(self, job_id: str) -> None:
    ...
    def run_character(self, job_id: str) -> None:
        job = self.jobs[job_id]
        request = job["request"]
        job_root = self.jobs_root / job_id
