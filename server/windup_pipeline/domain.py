"""Shared generation vocabulary and built-in character catalogue.

Adding an action, view or built-in character starts here. Transport and storage
code must not define its own competing copy of these values.
"""
